...
if($setCCleanerSchedTask -eq 0){ Install-BoxstarterPackage -PackageName "$scriptsUrlRoot/scripts/set_ccleaner_scheduled_task.ps1"-ComputerName $ServerName -Credential $Cred }
